...
public class GuiDirectionalXNetNetwork extends BaseGuiContainer {
    ...
    private final TileDirectionalXNetNetwork tile;
    ...
    public GuiDirectionalXNetNetwork(InventoryPlayer playerInventory, TileDirectionalXNetNetwork tile) {
        super(new ContainerDirectionalXNetNetwork(playerInventory, tile), tile, TEXTURE);
        this.tile = tile;

        generateInfo("tab." + WirelessUtils.MODID + ".directional_xnet_network");
    }
    ...
    public void initGui() {
        ...
        addElement(new ElementAreaButton(this, tile, 152, 59));
