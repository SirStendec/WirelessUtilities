...
public class ContainerAEBusAugment extends BaseContainerItem {
    ...
    public AEBusTickable.TransferMode getEnergyMode() {
        return AppliedEnergistics2Plugin.itemAEBusAugment.getEnergyMode(stack);
    }

    public AEBusTickable.TransferMode getItemsMode() {
        return AppliedEnergistics2Plugin.itemAEBusAugment.getItemsMode(stack);
    }

    public AEBusTickable.TransferMode getFluidMode() {
        return AppliedEnergistics2Plugin.itemAEBusAugment.getFluidMode(stack);
    }

    public boolean setEnergyMode(@Nullable AEBusTickable.TransferMode mode) {
    ...
    public boolean setItemsMode(@Nullable AEBusTickable.TransferMode mode) {
    ...
    public boolean setFluidMode(@Nullable AEBusTickable.TransferMode mode) {
