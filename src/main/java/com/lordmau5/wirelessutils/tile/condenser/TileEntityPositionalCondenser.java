...
public class TileEntityPositionalCondenser extends TileEntityBaseCondenser implements IRangeAugmentable, ISlotAugmentable, IUnlockableSlots, IPositionalMachine {
