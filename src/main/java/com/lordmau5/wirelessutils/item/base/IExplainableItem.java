...
public interface IExplainableItem {
    ...
    default void addExplanation(List<String> tooltip, String name, Object... args) {
        String path = name + ".0";
    ...
    default void addLocalizedLines(List<String> tooltip, String name, Object... args) {
        int i = 0;
        String path = name + "." + i;
    ...
    default void addLocalizedLines(List<String> tooltip, String name, Style style, Object... args) {
        int i = 0;
        String path = name + "." + i;
        while ( StringHelper.canLocalize(path) ) {
