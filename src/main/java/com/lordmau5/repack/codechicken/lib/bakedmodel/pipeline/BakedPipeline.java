 ...
 * it is recommended that you cache an extra {@link Quad} and pass that in here, from that you can immediately bake
 * either an {@link UnpackedBakedQuad} through {@link Quad#bakeUnpacked()} or a standard {@link BakedQuad} through
 * {@link Quad#bake()}, However, you can pass any {@link IVertexConsumer} in here.
